<?php
    ...
    require "./common.php";
        ...
        echo "<h2 style='padding-left: 20px; padding-top: 20px; font-family: serif;'>".'Congratulations! The Prescription has
        been saved.../nThis page will redirect back to patients in 5 seconds.'."</h2>";
        }
