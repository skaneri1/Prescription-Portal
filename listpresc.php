    ...
    <div class="container">
      ...
      <?php
         if (!$result && $statement->rowCount() == 0) { ?>
          <h4> No prescriptions to display for Shlok. Add one from the patients.</h4>
         <?php }
         else
         {
      ...
      <?php
         if (!$resulta && $statementa->rowCount() == 0) { ?>
          <h4> No prescriptions to display for Dhruv. Add one from the patients.</h4>
         <?php }
         else
         {
      ...
      <?php
         if (!$resultb && $statementb->rowCount() == 0) { ?>
          <h4> No prescriptions to display for Hari. Add one from the patients.</h4>
         <?php }
         else
         {
